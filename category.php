        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 text-uppercase text-primary"><img src="img/doc_logo.png" alt="Logo" style="width: 80px;margin-right: 10px;height: 85px;position: fixed;left: 3%;top: 6%;"></i>Schedulix Physician</h1>
                </a>
		...
		<mark>
           ...
           <div>
			<h2><b style="margin-left:-18px; color:#67bfff; font-family:Open Sans, Arial, sans-serif; font-size:14px; font-weight:700; color:#000;">ADD CATEGORY</b></h2>
                                <BR> 
                              <div class="box" style="    margin-top: 118px;margin-left:814px;">
			...
			<input type="submit" value="Submit" id = "btn_s" name="upload" style="background-color: #13C5DD;
    border-width: 2px; border-widthcolor: #13C5DD;
    color: #fff;
    width: 90px;
    height: 45px;
}"><br/></br>
