...
div.column{
   ...
   /* outline-style: solid; */
   outline-color: #13C5DD
   background-image: linear-gradient(to top, rgba(255,0,0,0),  #13C5DD 190%);
   width: 100em;
   margin-left: -399px;
    padding-left: 450px;
    height: 262px;
...
<body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-primary"><img src="img/doc_logo.png" alt="Logo" style="width: 80px;margin-right: 10px;height: 85px;position: fixed;left: 3%;top: 7%;"></i>Schedulix Physician</h1>
                    </a>
 ...
 var hamburger = document.querySelector(".hamburger");
    ...
    <h1 style="text-align:center;font-size: 18px; color: black;     padding-left: 121px; margin-left:-813px; margin-top:-34px;">Choose The Service</h1>
 </div>
 ...
 <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<div class="row det" style="width:991px";"backgroundcolor:#13C5DD">';
